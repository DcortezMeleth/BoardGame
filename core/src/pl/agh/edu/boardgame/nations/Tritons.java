...
import static pl.agh.edu.boardgame.nations.NationType.TRITONS;
...
public class Tritons extends BaseNation {
    ...
    /** Typ rasy */
    private final NationType nationType = TRITONS;
    ...
    static {
        liveArmiesTexture = new Texture(Gdx.files.internal(LIVE_ARMIES_TEXTURES_PATH + "trytony.png"));
        deadArmiesTexture = new Texture(Gdx.files.internal(DEAD_ARMIES_TEXTURES_PATH + "trytony.png"));
        liveBannerTexture = new Texture(Gdx.files.internal(LIVE_BANNERS_TEXTURES_PATH + "trytony.png"));
        deadBannerTexture = new Texture(Gdx.files.internal(DEAD_BANNERS_TEXTURES_PATH + "trytony.png"));
    }
    ...
    public int countAttackPerks(final int minArmySize, final Field field) {
        for(Field neighbour : field.getNeighbours()) {
            if(neighbour.getType() == BaseField.FieldType.LAKE) {
